  ...
  return (
    ...
    <section className="relative w-full h-80 md:h-110  flex items-center justify-center">
            ...
            <div className="relative z-20 w-full max-w-[1350px] mx-auto px-4 md:px-5 lg:px-8 flex flex-col gap-6 items-center justify-center">
              <h1 className="text-white font-bold text-3xl text-center sm:text-4xl md:text-5xl lg:text-6xl tracking-widest leading-tight" style={{fontFamily: 'Orbitron, sans-serif'}}>SERVICES</h1>
            </div>
          </section>
          <div className=" lg:px-25 px-5 ">

          <p className="max-w-337 color-primary text-xl md:text-3xl lg:text-4xl text-center md:text-left">Uttar Pradesh Pro Volleyball League</p>
          </div>
