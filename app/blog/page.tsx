    ...
    <main className="flex flex-col min-h-screen  bg-white overflow-x-hidden">
      <section className="relative w-full h-80 md:h-110  flex items-center justify-center">
        ...
        <div className="relative z-20 w-full max-w-[1350px] mx-auto px-4 md:px-5   lg:px-8 flex flex-col gap-6 items-center justify-center">
          <h1 className="text-white font-bold font-mokototext-3xl text-center sm:text-4xl md:text-5xl lg:text-6xl tracking-widest leading-tight">
            BLOGS
          </h1>
        </div>
      </section>
    ...
    <section className="w-full bg-white mt-15">
      ...
      <div className="max-w-[1350px] mx-auto px-4 md:px-5 lg:px-8 ">
        ...
        <div className="text-center  mb-8 md:mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl  color-primary mb-4">
            Blogs
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 ">
          {/* Blog Card 1 */}
          <div className="relative w-full h-96 md:h-[500px] border-1 border-gray-300 overflow-hidden group cursor-pointer">
            <Image
              src="/homeBanner.jpg"
    ...
    <section className="w-full bg-white">
      <div className="max-w-[1350px] mx-auto px-4 md:px-5 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 ">
          ...
          <div className="bg-blue-50 py-8 md:pb-12  md:pt-12 lg:pt-16 lg:pb-12 px-6 md:px-10 lg:px-12">
            {/* Content Block 1 */}
            <div className="pb-2 md:pb-3 border-b border-gray-400">
              <div className="text-center md:text-left">
                <h3 className="text-2xl md:text-2xl lg:text-3xl font-bold text-black mb-3 md:mb-4 leading-tight">
                ...
                <div className="flex justify-center md:justify-end">
                  <Link
                    href="/detailed-blog"
                    className="inline-block bg-black text-white px-3 md:px-4 py-2 md:py-2 rounded-xl font-medium text-sm md:text-base hover:opacity-90 transition-opacity"
                  >
                    READ HERE
                  </Link>
                </div>
